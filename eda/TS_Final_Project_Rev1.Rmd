...
# We collected the data for 5 businss cycles - 03/17/2015 to 03/19/2021
...
```{r Creating data by merging parameters, echo=FALSE}
...
```{r first-difference Overfitting, echo=FALSE}
...
# Used nnfor API - mlp function for univariate 
...
```
#================   Univeriate Ensemble Model  ==================
#=============ARIMA + NN  &  SignalPlus and Neural Net ==========
```{r Ensemble-Univeriate, echo=FALSE}
