...
author: "Kevin Thompson and Dhruba Dey"
date: "4/10/2021"
...
```{r Creatingdatabymerging parameters, include=FALSE}
...
```{r Checking-Stationarityanddecomposing, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r first-differenceOverfittingIdentifyingmodel, warning=FALSE, message=FALSE}
...
Both long-term and short-term forecasts end up getting the same windowed ASE for some strange
reason. 
